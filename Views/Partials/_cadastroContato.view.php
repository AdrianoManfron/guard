<button class="btn btn-primary bg-tertiary border-[#303030] text-medium leading-medium text-content-primary hover:border-brand hover:bg-brand hover:text-content-muted" onclick="add_contact.showModal()">+ Adicionar contato</button>
<dialog id="add_contact" class="modal modal-bottom sm:modal-middle bg-content-primary/20">
    ...
    <div class="modal-box bg-primary bg-opacity-80">
        <div class="flex flex-col gap-1">
            <div>
                ...
                <p class="text-heading leading-heading text-content-primary font-bold">Adicionar contato</p>
            </div>
            <div class="flex flex-col px-4 py-5 gap-4">
                <form action="/contatos" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-action">
                        <button type="reset" class="btn btn-primary bg-tertiary border-0 text-content-primary hover:bg-content-placeholder">Cancelar</button>
                        <button type="submit" class="btn btn-primary bg-brand border-brand text-content-inverse hover:bg-tertiary hover:text-content-primary hover:border-primary">Salvar</button>
                    </div>
            </div>
        </div>
    </div>
